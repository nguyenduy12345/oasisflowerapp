...
const Home = () => {
  ...
  return (
    ...
    <div className={styles["delivery"]}>
        <img loading="lazy" src="/src/assets/images/img/BRAND_USPS_1.jpg" />
    </div>
    <div className={styles["menu"]}>
        <div className={`${styles["menu__list"]} row m-0 justify-content-between`}>
            <div className={`${styles["menu__item"]} col-xs-12 col-sm-12 col-md-6 col-lg-4`}>
                <Link to="/flowers"><img loading="lazy" src="/src/assets/images/img/menu_products/flower.jpg" /></Link>
                <div className={styles["menu__name"]}><Link to="/flowers">{t('list-page-product.page-flowers')}</Link></div>
            </div>
            <div className={`${styles["menu__item"]} col-xs-12 col-sm-12 col-md-6 col-lg-4`}>
                <Link to="/cakes"><img loading="lazy" src="/src/assets/images/img/menu_products/horizontal-pulling-slice-from-cake.jpg" /></Link>
              
                <div className={styles["menu__name"]}><Link to="/cakes">{t('list-page-product.page-cakes')}</Link></div>
            </div>
            <div className={`${styles["menu__item"]} col-xs-12 col-sm-12 col-md-6 col-lg-4`}>
                <Link to="/accessories"><img loading="lazy" src="/src/assets/images/img/menu_products/gift.jpg" /></Link>             
                <div className={styles["menu__name"]}><Link to="/accessories">{t('list-page-product.page-accessories')}</Link></div>
            </div>
        </div>
    </div>
    <div className={styles["brands"]}>
        <img loading="lazy" src="/src/assets/images/img/PRESS_LOGOS_US_1.jpg" />
    </div>
    <div className={styles["events"]}>
        ...
        <div className={`${styles["events__list"]} row justify-content-between`}>
            <div className={`${styles["events__item"]} card col-xs-12 col-sm-12 col-md-6 col-lg-4`}>
                <Link to="/occasions"><img loading="lazy" src="/src/assets/images/img/events/WEDDING.jpg" /></Link>
            ...
            <div className={`${styles["events__item"]} card col-xs-12 col-sm-12 col-md-6 col-lg-4`}>
                <Link to=""><img loading="lazy" src="/src/assets/images/img/events/TF_DINNER.jpg" /></Link>
                <div className="card-body">
            ...
            <div className={`${styles["events__item"]} card col-xs-12 col-sm-12 col-md-6 col-lg-4`}>
                <Link to=""><img loading="lazy" src="/src/assets/images/img/events/Corinthia.jpg" /></Link>
                <div className="card-body">
    ...
    <div className={styles["about__image"]}>
        <img loading="lazy" src="/src/assets/images/img/about/TESTIMONIAL_DESKTOP_4.jpg" />
    </div>
    <div className={styles["about"]}>
        ...
        <div className={`${styles["about__list"]} row justify-content-between`}>
            <div className={`${styles["about__item"]} card col-xs-12 col-sm-12 col-md-6`}>
                <img loading="lazy" src="/src/assets/images/img/about/ab1.jpeg" />
                <div className="card-body">
            ...
            <div className={`${styles["about__item"]} card col-xs-12 col-sm-12 col-md-6`}>
                <img loading="lazy" src="/src/assets/images/img/about/ab2.jpeg" />
                <div className="card-body">
